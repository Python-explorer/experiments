...
ax.set_xlabel('ICB Name', fontsize=40)
ax.set_ylabel(selected_value_column, fontsize=40)
ax.set_title(f'{selected_value_column} by ICB Name for {selected_treatment_function}', fontsize=40)
plt.xticks(rotation=45, ha='right', fontsize=40)  # Adjust the rotation and alignment of x-axis labels
